        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 md:gap-8 py-10 max-sm:max-w-sm max-sm:mx-auto gap-y-8">
            <div className="col-span-full mb-10 lg:col-span-1 lg:mb-0">
              <img
                className="mb-2"
                src="https://rider.chennaicyclists.com/_app/immutable/assets/CC_Logo_Green_White.228e51aa.svg"
                width="150"
                height="30"
                alt="Chennai Cyclists Logo"
              />
              <div className="flex space-x-3 lg:mt-0 ">
                ...
                <a
                  href="javascript:;"
                  className="w-8 h-8 rounded-full transition-all duration-500 flex justify-center items-center bg-black hover:bg-gray-900"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="20"
                ...
                <a
                  href="javascript:;"
                  className="relative w-8 h-8 rounded-full transition-all duration-500 flex justify-center items-center bg-black  hover:bg-gradient-to-b from-gray-900 to-gray-900  
                        "
                >
                  <svg
